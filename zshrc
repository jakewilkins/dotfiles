...
alias gpp='git push origin `git-branch-current`'
alias opr='open $(git remote get-url origin)/pull/$(git-branch-current)'
alias gcompare='open $(git remote get-url origin)/compare/$(git-branch-current)'
